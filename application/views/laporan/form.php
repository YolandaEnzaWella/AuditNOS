    ...
    <div class="col-lg-8">
        <div class="card shadow-sm border-bottom-success">
            <div class="card-header bg-white py-3">
                <h4 class="h5 align-middle m-0 font-weight-bold text-gray-900">
                    Form Laporan
                </h4>
            </div>
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="custom-control custom-radio">
                            <input value="data_barang" type="radio" id="data_barang" name="transaksi" class="custom-control-input">
                            <label class="custom-control-label" for="data_barang">Data Barang</label>
                        </div>
                        <div class="custom-control custom-radio">
