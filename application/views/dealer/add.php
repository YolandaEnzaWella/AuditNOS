        ...
        <div class="card shadow-sm mb-4 border-bottom-primary">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('dealer') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="<?= set_value('kode_dealer'); ?>" type="text" id="kode_dealer" name="kode_dealer" class="form-control" placeholder="Kode Dealer">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="<?= set_value('nama_dealer'); ?>" type="text" id="nama_dealer" name="nama_dealer" class="form-control" placeholder="Nama Dealer">
                    ...
                    <div class="col-md-6">
                        <select name="dealer_id_distrik" id="dealer_id_distrik" class="custom-select select">
                            ...
                            <?php foreach ($distrik as $dis) : ?>
                                <option <?= set_select('dealer_id_distrik', $dis['id_distrik']) ?> value="<?= $dis['id_distrik'] ?>"><?= $dis['nama'] ?></option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="<?= set_value('jenis_dealer'); ?>" type="text" id="jenis_dealer" name="jenis_dealer" class="form-control" placeholder="Jenis Dealer">
