        ...
        <div class="card shadow-sm mb-4 border-bottom-primary">
            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="<?= set_value('csi_kode'); ?>" type="text" id="csi_kode" name="csi_kode" class="form-control" placeholder="Kode Penilaian">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <textarea name="csi_indikator" id="csi_indikator" class="form-control" placeholder="Indikator Penilaian" cols="30" rows="10"><?= set_value('csi_indikator'); ?></textarea>
