        ...
        <div class="card shadow-sm mb-4 border-bottom-primary">
            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="<?= set_value('mci_atribut', $mci['mci_atribut']); ?>" type="text" id="mci_atribut" name="mci_atribut" class="form-control" placeholder="Atribut Penilaian">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="mci_map_id" id="mci_map_id">
                            <?php foreach ($mci_map_id as $id => $key) : ?>
                                <option value="<?= $id; ?> <?= $mci['mci_map_id'] == $id ? 'selected' : ''; ?>"><?= $key; ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="mci_penilaian" id="mci_penilaian">
                            <?php foreach ($mci_penilaian as $id => $key) : ?>
                                <option value="<?= $id; ?>" <?= $mci['mci_penilaian'] == $id ? 'selected' : ''; ?>><?= $key; ?></option>
                            <?php endforeach; ?>
                        </select>
