    ...
    <div class="col-md-8">
        <div class="card shadow-sm mb-4 border-bottom-primary">
            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                <label class="col-md-4 text-md-right" for="dealer_id">Pilih User Dealer</label>
                    <div class="col-md-6">
                        <select name="dealer_id" id="dealer_id" class="custom-select select">
                            <option value="" selected disabled>Pilih Dealer</option>
                            <?php foreach ($dealer as $dlr) : ?>
                                <option <?= set_select('dealer_id', $dlr['id_dealer']) ?> value="<?= $dlr['id_dealer'] ?>"><?= $dlr['nama_dealer'] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <?= form_error('dealer_id', '<small class="text-danger">', '</small>'); ?>
                </div>
                <div class="row form-group">
