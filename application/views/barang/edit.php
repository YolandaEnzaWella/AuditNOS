    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="nama_barang">Harga Barang</label>
                    <div class="col-md-9">
                        <input value="<?= set_value('harga_barang', $barang['harga_barang']); ?>" name="harga_barang" id="harga_barang" type="text" class="form-control" placeholder="Harga Barang...">
                        <?= form_error('harga_barang', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                  <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="stok_barang">Stok Barang</label>
                    <div class="col-md-9">
                        <input value="<?= set_value('stok', $barang['stok']); ?>" name="stok" id="stok" type="text" readonly class="form-control" placeholder="Stok Barang...">
